...
{{Form::model($contemplative, ['method' => 'PATCH', 'action' => ['ContemplativeController@update', $contemplative->id]])}}
    ...
    <div class="pull-right">
       	<div class="form-group">
        {{Form::open(['method' => 'DELETE', 'route' => ['contemplative.destroy', $contemplative->id], 'class' => 'delete'])}}
