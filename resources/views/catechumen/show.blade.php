...
<h2>{{$rcia->firstName}} {{$rcia->middleName}} {{$rcia->lastName}}  <small><a style="color:red" href="{{url('/RCIA/'.$rcia->id.'/edit')}}">edit|delete</a></small></h2>
<ul>
...
<li>Have you or your spouce/fiancee ever been divorced? <span style="color:#337ab7">{{$rcia->married_divorced}}</span></li>
...
<li>Are you or your spouce/fiancee presently seeking an annulment? <span style="color:#337ab7">{{$rcia->annulment_pending}}</span></li>
<li>Has your spouce/fiancee ever been baptized? <span style="color:#337ab7">{{$rcia->spouse_baptized}}</span></li>
