...
{{Form::model($volunteer, ['method' => 'PATCH', 'action' => ['VolunteerController@update', $volunteer->id]])}}
...
<div class='pull-right'>
    ...
    <div class="pull-right">
       	<div class="form-group">
        {{Form::open(['method' => 'DELETE', 'route' => ['volunteer.destroy', $volunteer->id], 'class' => 'delete'])}}
