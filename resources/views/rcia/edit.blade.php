...
{{Form::model($rcia, ['method' => 'PATCH', 'action' => ['RciaController@update', $rcia->id]])}}
	...
	<div class="form-group">
		...
		{{Form::input('date', 'dob', null, ['class' => 'form-inline'])}}
		{{Form::label('phone', 'Phone Number:')}}
		{{Form::text('phone', null, ['class' => 'form-inline', 'placeholder' => 'Enter Phone Number'])}}
	</div>
	<div class="form-group">
