...
{{Form::open(['method' => 'POST', 'action' => 'MembersController@store'])}}
		<div class="form-group">
			...
			{{Form::text('familyName', null, ['class' => 'form-inline', 'placeholder' => 'Enter Family Name'])}}
			{{Form::label('todaysDate', 'Todays Date:')}}
			{{Form::input('date', 'todaysDate', null, ['class' => 'form-inline'])}}
		</div>
		<h3>Head of Household (Active Catholic)</h3>
		<div class="form-group">
			{{Form::label('tNameOne', 'Full Name:')}}
			{{Form::select('tNameOne', ['Mr.' => 'Mr.', 'Ms.' => 'Ms.', 'Mrs.' => 'Mrs.'])}}
			{{Form::text('fNameOne', null, ['class' => 'form-inline', 'placeholder' => 'Enter First Name'])}}
			{{Form::text('mNameOne', null, ['class' => 'form-inline', 'placeholder' => 'Enter Middle Name'])}}
			{{Form::text('lNameOne', null, ['class' => 'form-inline', 'placeholder' => 'Enter Last Name'])}}
		</div>		
		<div class="form-group">
		...
		<div class="form-group">
			...
			{{Form::input('date', 'dobOne', null, ['class' => 'form-control'])}}
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			{{Form::text('homePhone', null, ['class' => 'form-control', 'placeholder' => 'Enter Home Phone'])}}
		</div>
		<div class="form-group">
			{{Form::label('cellPhoneOne', 'Cell Phone:')}}
			{{Form::text('cellPhoneOne', null, ['class' => 'form-control', 'placeholder' => 'Enter Cell Phone'])}}
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			{{Form::text('workPhoneOne', null, ['class' => 'form-control', 'placeholder' => 'Enter Work Phone'])}}
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<h3>Spouse</h3>{{Form::label('active', 'Active Catholic?')}}
            {{Form::select('active', ['No' => 'No', 'Yes' => 'Yes'])}}
		</div>
		<div class="form-group">
			{{Form::label('tNameOne', 'Full Name:')}}
			{{Form::select('tNameTwo', ['Mr.' => 'Mr.', 'Ms.' => 'Ms.', 'Mrs.' => 'Mrs.'])}}
			{{Form::text('fNameTwo', null, ['class' => 'form-inline', 'placeholder' => 'Enter First Name'])}}
			{{Form::text('mNameTwo', null, ['class' => 'form-inline', 'placeholder' => 'Enter Middle Name'])}}
			{{Form::text('lNameTwo', null, ['class' => 'form-inline', 'placeholder' => 'Enter Last Name'])}}
		</div>
			<div class="form-group">
		...
		<div class="form-group">
			...
			{{Form::input('date', 'dobTwo', null, ['class' => 'form-control'])}}
		</div>	
		<div class="form-group">
			{{Form::label('cellPhoneTwo', 'Cell Phone:')}}
			{{Form::text('cellPhoneTwo', null, ['class' => 'form-control', 'placeholder' => 'Enter Cell Phone'])}}
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			{{Form::text('workPhoneTwo', null, ['class' => 'form-control', 'placeholder' => 'Enter Work Phone'])}}
		</div>
		<div class="form-group">
		...
		<div class="form-group">
            {{ Form::checkbox('okPhone', 'delete') }} {!! Form::label('deleated_at', 'Delete Employee') !!}            
        </div>		
